...
export default function SearchHomeStay(props) {
    ...
    const convertToLunar = (date) => {
        const lunarDate = LunarCalendar.solarToLunar(date.year(), date.month() + 1, date.date());
    ...
    const dateRender = (current) => {
        ...
        return (
            <div className="ant-picker-cell-inner">
                ...
                <div className="lunar">{lunarDateString}</div> {/* Display lunar date */}
            </div>
        );
    };
    return (
        <div className={`${styles.box_body}`}>
            ...
            <div className={`${styles.body_dive}`} style={{ position: "relative" }}>
                <div className={styles.calendar} style={{ position: "absolute", visibility: 'hidden' }}>
                ...
                <div className={`${styles.item_child}`}>
                    ...
                    <div className={`${styles.inp_date}`}>
                        <Input
                            ...
                            value={dates[0] ? formatDateString(dates[0].format('DD/MM/YYYY')) : formatDateString(dayjs().format('DD/MM/YYYY'))}
                            readOnly
                        />
                    </div>
                </div>
                ...
                <div className={`${styles.item_child}`}>
                    ...
                    <div className={`${styles.inp_date}`}>
                        <Input
                            onFocus={handlePickerOpen}
                            id="range-picker-input"
                            value={dates[1] ? formatDateString(dates[1].format('DD/MM/YYYY')) : formatDateString(dayjs().format('DD/MM/YYYY'))}
                            readOnly
                        />
                    </div>
                </div>
            ...
            <div className={`${styles.body_item}`}>
                ...
                <div className={`${styles.inp_text}`} onClick={(e) => { setShowSn(true) }}>
                    <span> {getAdult} Người lớn, {getChildren} Trẻ em </span>
                </div>
            </div>
