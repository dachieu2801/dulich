      ...
      <div className={`${styles.head_left}`}>
        ...
        >
          <div className={`${styles.menu}`}>
            <div
              className={`${styles.item_menu} ${styles.item_menu_1} ${
                props.active == 1 ? styles.item_active : ""
              }`}
            >
            ...
            <div
              className={`${styles.item_menu} ${styles.item_menu_1} ${
                styles.item_menu_1
              } ${props.active == 2 ? styles.item_active : ""}`}
            >
            ...
            <div
              className={`${styles.item_menu} ${styles.item_menu_1} ${
                styles.item_menu_1
              } ${props.active == 3 ? styles.item_active : ""}`}
            >
              <Link href="/homestay">Homestay</Link>
            </div>
            <div
              className={`${styles.item_menu} ${styles.item_menu_1} ${
                props.active == 4 ? styles.item_active : ""
              }`}
            >
            ...
            <div
              className={`${styles.item_menu} ${styles.item_menu_1} ${
                props.active == 5 ? styles.item_active : ""
              }`}
            >
              <Link href="#">Tour</Link>
            </div>
            <div
              className={`${styles.item_menu} ${styles.item_menu_1} ${
                props.active == 6 ? styles.item_active : ""
              }`}
            >
              <Link href="#">Chuyến xe</Link>
            </div>
            <div
              className={`${styles.item_menu} ${styles.item_menu_1} ${
                props.active == 7 ? styles.item_active : ""
              }`}
            >
            ...
            <div
              className={`${styles.item_menu} ${styles.item_menu_1} ${
                props.active == 8 ? styles.item_active : ""
              }`}
            >
            ...
            <div
              className={`${styles.item_menu} ${styles.item_menu_1} ${
                props.active == 9 ? styles.item_active : ""
              }`}
            >
              <Link href="#">Blog</Link>
            </div>
